...
class EventModel:
    ...
    def insert(self, type, date, time, user, grade,  pupil_number, get_list, get_payment, comment):
        cursor = self.connection.cursor()
        cursor.execute('''INSERT INTO events 
                          (type, date, time, user, grade,  pupil_number, get_list, get_payment, comment) 
                          VALUES (?,?,?,?,?,?,?,?,?)''', (type, date, time, user, grade,  pupil_number, get_list, get_payment, comment))
        cursor.close()
        self.connection.commit()
